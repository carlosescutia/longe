...
<div class="modal fade" id="dlg_borrar_archivo" tabindex="-1" aria-labelledby="dlg_borrar_archivo" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="text-center"><span id="item_eliminar_archivo"></span></h3>
            </div>
            <div class="modal-footer">
                <form method="post" enctype="multipart/form-data" action="<?= base_url() ?>archivos/eliminar">
                    ...
                    <input type="hidden" id="url_actual_archivo" name="url_actual" value="url">
...
<script>
    function pass_data_archivo(item_eliminar, url_actual, dir_docs) {
        $("#item_eliminar_archivo").text(item_eliminar);
        $('#nombre_archivo').val(item_eliminar);
        $('#url_actual_archivo').val(url_actual);
